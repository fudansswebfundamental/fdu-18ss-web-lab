...
<main class="container">
    ...
    <div class="btn-group countryButtons" role="group" aria-label="...">
        ...
        /* for ($i = 0; $i < count($countries); $i++) {
             echo "<a role='button' class='btn btn-default' href='list.php' >$countries[$i]</a>";
         }*/
    ...
    <ul class="caption-style-2">
        ...
        foreach ($images as $id => $image) {
            $href1="detail.php？id=".$id;
            $img_src="images/square/".$image["path"];
            $alt=$image["title"];
            echo "<li>";
            echo "<a class='img-responsive' href=$href1 >";
